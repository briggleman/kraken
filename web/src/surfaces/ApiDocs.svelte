    ...
    <nav class="api-jump" aria-label="Jump to a group"><a href="#api-auth">auth</a><a href="#api-servers">servers</a><a href="#api-specs">game specs</a><a href="#api-nodes">nodes</a><a href="#api-files">files</a><a href="#api-backups">backups</a><a href="#api-schedules">schedules</a><a href="#api-users">users &amp; access</a><a href="#api-enrollment">agent enrollment</a><a href="#api-setup">setup &amp; catalog</a><a href="#api-settings">panel settings</a><a href="#api-dns">dns &amp; forwards</a><a href="#api-audit">audit</a><a href="#api-streams">streams</a><a href="#api-meta">meta</a></nav>
      ...
      <section class="api-sec" id="api-servers" aria-label="servers">
        ...
        <details class="ep m-delete w">
          <summary class="ep-sum"><span class="ep-m">DELETE</span><span class="ep-p">/servers/<em>&#123;id&#125;</em></span><span class="ep-r"><span class="ep-s">permanently delete a retired server, archives included</span></span></summary>
          <div class="ep-d"><div class="ep-grp"><h5>parameters</h5><p class="ep-line"><b>id</b> <em>path · required</em></p></div><div class="ep-grp"><h5>responses</h5><p class="ep-line"><b class="ep-code s2">200</b> <em>gone — row, world and archives; a note when archives on a shared target were kept</em></p><p class="ep-line"><b class="ep-code s4">404</b> <em>no such server</em></p><p class="ep-line"><b class="ep-code s4">409</b> <em>server_not_retired — retire it first</em></p></div></div>
        </details>
        <details class="ep m-post w">
        ...
        <details class="ep m-post w">
          ...
          <div class="ep-d"><div class="ep-grp"><h5>parameters</h5><p class="ep-line"><b>id</b> <em>path · required</em></p></div><div class="ep-grp"><h5>request body</h5><p class="ep-line"><b>application/json</b> <em>· action: start | stop | restart | kill</em></p></div><div class="ep-grp"><h5>responses</h5><p class="ep-line"><b class="ep-code s2">202</b> <em>accepted — the agent is working on it</em></p><p class="ep-line"><b class="ep-code s4">409</b> <em>already in that state</em></p><p class="ep-line"><b class="ep-code s5">503</b> <em>the node could not be reached, or did not answer in time — a stop may still be finishing there</em></p></div><div class="ep-grp"><h5>access</h5><p class="ep-line"><em>operator and up</em></p></div></div>
        </details>
        <details class="ep m-get">
          <summary class="ep-sum"><span class="ep-m">GET</span><span class="ep-p">/servers/<em>&#123;id&#125;</em>/install-log</span><span class="ep-r"><span class="ep-s">the retained output of the most recent install, and the one before it</span></span></summary>
          <div class="ep-d"><div class="ep-grp"><h5>parameters</h5><p class="ep-line"><b>id</b> <em>path · required</em></p></div><div class="ep-grp"><h5>responses</h5><p class="ep-line"><b class="ep-code s2">200</b> <em>lines, done, retained, started_ms, finished_ms — and previous: the attempt this one replaced, in the same shape, or null. held in panel memory only, so retained is false after a panel restart</em></p><p class="ep-line"><b class="ep-code s4">404</b> <em>no such server</em></p></div><div class="ep-grp"><h5>access</h5><p class="ep-line"><em>viewer and up</em></p></div></div>
        </details>
        <details class="ep m-get">
      ...
      <section class="api-sec" id="api-nodes" aria-label="nodes">
        ...
        <details class="ep m-get">
          ...
          <div class="ep-d"><div class="ep-grp"><h5>parameters</h5><p class="ep-line"><b>id</b> <em>path · required</em></p></div><div class="ep-grp"><h5>responses</h5><p class="ep-line"><b class="ep-code s2">200</b> <em>os, cpu, memory, disk, agent version</em></p><p class="ep-line"><b class="ep-code s5">503</b> <em>the node did not answer in time</em></p></div><div class="ep-grp"><h5>access</h5><p class="ep-line"><em>viewer and up</em></p></div></div>
        </details>
        </div>
      </section>
      ...
      <section class="api-sec" id="api-files" aria-label="files">
        ...
        <details class="ep m-get">
          ...
          <div class="ep-d"><div class="ep-grp"><h5>parameters</h5><p class="ep-line"><b>id</b> <em>path · required</em></p><p class="ep-line"><b>path</b> <em>query · required</em></p><p class="ep-line"><b>token</b> <em>query · optional · a one-time download token instead of the session header</em></p></div><div class="ep-grp"><h5>responses</h5><p class="ep-line"><b class="ep-code s2">200</b> <em>the file as an octet stream</em></p><p class="ep-line"><b class="ep-code s4">401</b> <em>the token is spent, expired, or not for this path</em></p><p class="ep-line"><b class="ep-code s4">404</b> <em>no such server or file — a JSON error, never a file</em></p><p class="ep-line"><b class="ep-code s4">409</b> <em>the file is in use, or the node refused — the reason is in the body</em></p><p class="ep-line"><b class="ep-code s5">503</b> <em>the node is unreachable</em></p></div><div class="ep-grp"><h5>access</h5><p class="ep-line"><em>operator and up</em></p></div></div>
        </details>
        <details class="ep m-get">
          <summary class="ep-sum"><span class="ep-m">GET</span><span class="ep-p">/servers/<em>&#123;id&#125;</em>/files/download</span><span class="ep-r"><span class="ep-s">download a token's path set as a zip</span></span></summary>
          <div class="ep-d"><div class="ep-grp"><h5>parameters</h5><p class="ep-line"><b>id</b> <em>path · required</em></p><p class="ep-line"><b>token</b> <em>query · required · the paths come from the token, not the URL</em></p></div><div class="ep-grp"><h5>responses</h5><p class="ep-line"><b class="ep-code s2">200</b> <em>a zip stream</em></p><p class="ep-line"><b class="ep-code s4">400</b> <em>no token supplied</em></p><p class="ep-line"><b class="ep-code s4">401</b> <em>the token is spent, expired, or not for this server</em></p></div><div class="ep-grp"><h5>access</h5><p class="ep-line"><em>whoever minted the token, re-checked on redemption</em></p></div></div>
        </details>
        <details class="ep m-post w">
        ...
        <details class="ep m-post w">
          <summary class="ep-sum"><span class="ep-m">POST</span><span class="ep-p">/servers/<em>&#123;id&#125;</em>/files/download-token</span><span class="ep-r"><span class="ep-s">mint a one-time download token</span></span></summary>
          <div class="ep-d"><div class="ep-grp"><h5>parameters</h5><p class="ep-line"><b>id</b> <em>path · required</em></p></div><div class="ep-grp"><h5>request body</h5><p class="ep-line"><b>application/json</b> <em>· exactly one of path or paths[]</em></p></div><div class="ep-grp"><h5>responses</h5><p class="ep-line"><b class="ep-code s2">201</b> <em>url, kind, expires_at — good once, for 60 seconds</em></p><p class="ep-line"><b class="ep-code s4">400</b> <em>no path, both shapes, or one that escapes the tree</em></p><p class="ep-line"><b class="ep-code s4">404</b> <em>no such server, or one this user may not reach</em></p></div><div class="ep-grp"><h5>access</h5><p class="ep-line"><em>operator and up</em></p></div></div>
        </details>
        <details class="ep m-post w">
